...
19:29 <jonatack> (see latest commit https://github.com/bitcoin-core-review-club/bitcoin/commit/c4a23a1)
...
19:32 <jonatack> Question: According to commit 61e2e97 (https://github.com/bitcoin-core-review-club/bitcoin/commit/61e2e97), using both txid and wtxid-based relay with peers means that we could sometimes
...
17:57 <jonatack> sdaftuar: right, looking at the latest commit at https://github.com/bitcoin-core-review-club/bitcoin/commit/c4a23a1. Was the test failure in p2p_tx_download.py?
...
21:35 <gribble> https://github.com/bitcoin/bitcoin/pull/15505 | p2p: Request NOTFOUND transactions immediately from other outbound peers, when possible by sdaftuar · Pull Request #15505 · bitcoin/bitcoin · GitHub
