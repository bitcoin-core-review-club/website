...
When implementing this PR, i pulled most code over from the [elements blockchain](https://github.com/ElementsProject/elements/). In elements they implemented new arithmetic opcodes as fixed size 64 bit signed integers.
...
Q: Is this `OP_SIZE` implementation safe for future soft forks? Look at the control flow.
